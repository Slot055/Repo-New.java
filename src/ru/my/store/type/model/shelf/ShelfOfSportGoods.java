...
public class ShelfOfSportGoods extends Shelf {
    ...
    public Product[] productOnTheShelf = {new Ball("Мяч футбольный", 1500.00, 0, "Кожа", "Футбол",
            "Мультиколор", 5, "США", "Профессиональный", "5", 0.5, "Adidas", "Круглый"),
            new Ball("Мяч футбольный", 1000.00, 1, "Кожа", "Футбол",
                    "Мультиколор", 5, "США", "Тренировочный", "5", 0.5, "Reebok", "Круглый"),
            new Ball("Мяч баскетбольный", 1750.00, 2, "Полиуретан", "Баскетбол",
                    "Коричневый", 7, "США", "Профессиональный", "5", 0.5, "Nike", "Круглый"),
            new Ball("Мяч для гольфа", 600.00, 4, "Текстиль", "Гольф",
                    "Коричневый", 4, "США", "Профессиональный", "5", 0.5, "Adidas", "Круглый"),
            new Ball("Мяч воллейбольный", 1650.00, 5, "Кожа", "Воллейбол",
